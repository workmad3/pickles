    ...
    request = http.request(opts, function(response) {
      ...
      response.on("end", function() {
        ...
        weather = {
          ...
          today: ("" + body.forecast[0].condition + ": ") + ("high - " + body.forecast[0].high_temperature + "°C, ") + ("low - " + body.forecast[0].low_temperature + "°C"),
          tomorrow: ("" + body.forecast[1].condition + ": ") + ("high - " + body.forecast[1].high_temperature + "°C, ") + ("low - " + body.forecast[1].low_temperature + "°C")
        };
