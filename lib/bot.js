(function() {
  var client, desc, descriptions, dispatch, error, fortune, github, handlers, hear, image, imdb, irc, irc_channels, irc_name, irc_server, isup, listen, say, seen, success, sys, time, weather;
  irc = require("irc");
  sys = require("sys");
